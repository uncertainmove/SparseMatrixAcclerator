...
class Info_P1 info_p1_self_rd,info_p1_self_wr;

class Info_P6 info_p6_self_rd,info_p6_self_wr;

class Info_P5 info_p5_self_rd,info_p5_self_wr;

class Info_P7 info_p7_self_rd,info_p7_self_wr;


class Info_P_AIE_Global info_p_aie_global_rd,info_p_aie_global_wr;
...
void compute_connect(Pipe* pipes){
    ...
    pipes[5].bind(&info_p_aie_global_wr,&info_p_aie_global_rd);
    pipes[6].bind(&info_p1_self_wr,&info_p1_self_rd);
}
